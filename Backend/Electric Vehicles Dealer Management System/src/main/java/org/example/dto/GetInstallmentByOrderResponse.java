...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Response object for installment information by order ID")
public class GetInstallmentByOrderResponse {
    ...
    @Schema(description = "Success message", example = "Installment information retrieved successfully")
