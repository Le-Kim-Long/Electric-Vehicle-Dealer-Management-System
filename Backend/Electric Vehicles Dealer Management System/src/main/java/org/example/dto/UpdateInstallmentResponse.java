...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Response object for updated installment plan")
public class UpdateInstallmentResponse {
    ...
    @Schema(description = "Additional notes", example = "Updated terms for customer")
    private String note;

    @Schema(description = "Success message", example = "Installment plan updated successfully")
