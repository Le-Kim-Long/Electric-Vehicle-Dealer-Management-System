...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Request object for updating an installment plan")
public class UpdateInstallmentRequest {
    ...
    @Schema(description = "Additional notes for the installment plan", example = "Updated terms for customer")
    private String note;
}
