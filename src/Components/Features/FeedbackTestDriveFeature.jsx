  ...
  return (
    <div className="feedback-testdrive-feature">
      <div className="feature-header">
        ...
        <p>Quản lý lịch hẹn lái thử và phản hồi từ khách hàng</p>
        <div style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>
          📊 Tổng: {allTestDrives.length} lịch hẹn | 
          🆕 Real: {JSON.parse(localStorage.getItem('testDriveBookings') || '[]').length} | 
          📝 Mock: {mockTestDrives.length} |
          💰 Quotes: {JSON.parse(localStorage.getItem('quoteRequests') || '[]').length}
        </div>
      </div>
